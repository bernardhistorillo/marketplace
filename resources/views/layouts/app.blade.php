...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Figtree:wght@300;400;500;700&family=Roboto:wght@400;700&display=swap" rel="stylesheet">

    <link rel="icon" href="{{ asset('img/ownly/own-token.webp') }}">
    ...
    <title>Ownly Market - @yield('title')</title>
</head>
<body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/multi-clamp@2.0.2/MultiClamp.min.js" integrity="sha256-b1GmBaQnGvPGVVEWmbPCLB9wrP63jDeTScWGk/GJiS8=" crossorigin="anonymous"></script>
